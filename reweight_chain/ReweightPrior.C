...
void ReweightPrior(std::string ReducedChain, int prior = -1){
	if (prior == -1 ){
	...
	std::string sout = ReducedChain.substr(0,pos) + "_reweighted.root";
	...
	// Variables needed for RC reweight in sin^2 theta_13
	double new_central = 0.0218;                 //0.0220;
	double new_error = 0.0007;
